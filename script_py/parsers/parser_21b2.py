# -*- coding: utf-8 -*-
"""
Created on Fri Sep 11 15:35:58 2026
...
def _make_measure_data(classi, valori, misura):
    """
    Crea colonne del tipo:

        Classe I | N
        Classe II | N
        Classe I | Percentuale
        Classe II | Percentuale
    """
    return {
...
def parse_descrittore_21b2(
    dat,
    descrittore="2.1.b.2"
):
    """
    Parser del descrittore 2.1.b.2.
    ...
    Per le scuole conserva sia N sia Percentuale.

    Per provincia, regione e Italia sono presenti
    soltanto le percentuali.
    """
